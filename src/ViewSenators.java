 ...
 * @author rainier
 */
public class ViewSenators extends javax.swing.JFrame {

    /**
     * Creates new form ViewSenators
     */
    public ViewSenators() {
        initComponents();
        viewSenators();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSenators.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSenators().setVisible(true);
            }
        });
    }
